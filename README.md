...
## Files
- `fhir_final_bundle.json` – FHIR provider bundle
- Notebook – full pipeline implementation

## Purpose
Demonstrate how synthetic data can be made interoperable and used in clinical decision support systems.
